...
(function(r){var LATIN_MAP={"À":"A","Á":"A","Â":"A","Ã":"A","Ä":"A","Å":"A","Æ":"AE","Ç":"C","È":"E","É":"E","Ê":"E","Ë":"E","Ì":"I","Í":"I","Î":"I","Ï":"I","Ð":"D","Ñ":"N","Ò":"O","Ó":"O","Ô":"O","Õ":"O","Ö":"O","O":"O","Ø":"O","Ù":"U","Ú":"U","Û":"U","Ü":"U","U":"U","Ý":"Y","Þ":"TH","ß":"ss","à":"a","á":"a","â":"a","ã":"a","ä":"a","å":"a","æ":"ae","ç":"c","è":"e","é":"e","ê":"e","ë":"e","ì":"i","í":"i","î":"i","ï":"i","ð":"d","ñ":"n","ò":"o","ó":"o","ô":"o","õ":"o","ö":"o","o":"o","ø":"o","ù":"u","ú":"u","û":"u","ü":"u","u":"u","ý":"y","þ":"th","ÿ":"y"};var LATIN_SYMBOLS_MAP={"©":"(c)"};var GREEK_MAP={"a":"a","ß":"b","?":"g","d":"d","e":"e","?":"z","?":"h","?":"8","?":"i","?":"k","?":"l","µ":"m","?":"n","?":"3","?":"o","p":"p","?":"r","s":"s","t":"t","?":"y","f":"f","?":"x","?":"ps","?":"w","?":"a","?":"e","?":"i","?":"o","?":"y","?":"h","?":"w","?":"s","?":"i","?":"y","?":"y","?":"i","?":"A","?":"B","G":"G","?":"D","?":"E","?":"Z","?":"H","T":"8","?":"I","?":"K","?":"L","?":"M","?":"N","?":"3","?":"O","?":"P","?":"R","S":"S","?":"T","?":"Y","F":"F","?":"X","?":"PS","O":"W","?":"A","?":"E","?":"I","?":"O","?":"Y","?":"H","?":"W","?":"I","?":"Y"};var TURKISH_MAP={"s":"s","S":"S","i":"i","I":"I","ç":"c","Ç":"C","ü":"u","Ü":"U","ö":"o","Ö":"O","g":"g","G":"G"};var RUSSIAN_MAP={"?":"a","?":"b","?":"v","?":"g","?":"d","?":"e","?":"yo","?":"zh","?":"z","?":"i","?":"j","?":"k","?":"l","?":"m","?":"n","?":"o","?":"p","?":"r","?":"s","?":"t","?":"u","?":"f","?":"h","?":"c","?":"ch","?":"sh","?":"sh","?":"","?":"y","?":"","?":"e","?":"yu","?":"ya","?":"A","?":"B","?":"V","?":"G","?":"D","?":"E","?":"Yo","?":"Zh","?":"Z","?":"I","?":"J","?":"K","?":"L","?":"M","?":"N","?":"O","?":"P","?":"R","?":"S","?":"T","?":"U","?":"F","?":"H","?":"C","?":"Ch","?":"Sh","?":"Sh","?":"","?":"Y","?":"","?":"E","?":"Yu","?":"Ya"};var UKRAINIAN_MAP={"?":"Ye","?":"I","?":"Yi","?":"G","?":"ye","?":"i","?":"yi","?":"g"};var CZECH_MAP={"c":"c","d":"d","e":"e","n":"n","r":"r","š":"s","t":"t","u":"u","ž":"z","C":"C","D":"D","E":"E","N":"N","R":"R","Š":"S","T":"T","U":"U","Ž":"Z"};var POLISH_MAP={"a":"a","c":"c","e":"e","l":"l","n":"n","ó":"o","s":"s","z":"z","z":"z","A":"A","C":"C","E":"e","L":"L","N":"N","Ó":"o","S":"S","Z":"Z","Z":"Z"};var LATVIAN_MAP={"a":"a","c":"c","e":"e","g":"g","i":"i","k":"k","l":"l","n":"n","š":"s","u":"u","ž":"z","A":"A","C":"C","E":"E","G":"G","I":"i","K":"k","L":"L","N":"N","Š":"S","U":"u","Ž":"Z"};var ALL_DOWNCODE_MAPS=new Array;ALL_DOWNCODE_MAPS[0]=LATIN_MAP;ALL_DOWNCODE_MAPS[1]=LATIN_SYMBOLS_MAP;ALL_DOWNCODE_MAPS[2]=GREEK_MAP;ALL_DOWNCODE_MAPS[3]=TURKISH_MAP;ALL_DOWNCODE_MAPS[4]=RUSSIAN_MAP;ALL_DOWNCODE_MAPS[5]=UKRAINIAN_MAP;ALL_DOWNCODE_MAPS[6]=CZECH_MAP;ALL_DOWNCODE_MAPS[7]=POLISH_MAP;ALL_DOWNCODE_MAPS[8]=LATVIAN_MAP;var Downcoder=new Object;Downcoder.Initialize=function(){if(Downcoder.map)return;Downcoder.map={};Downcoder.chars="";for(var i in ALL_DOWNCODE_MAPS){var lookup=ALL_DOWNCODE_MAPS[i];for(var c in lookup){Downcoder.map[c]=lookup[c];Downcoder.chars+=c}}Downcoder.regex=new RegExp("["+Downcoder.chars+"]|[^"+Downcoder.chars+"]+","g")};downcode=function(slug){Downcoder.Initialize();var downcoded="";var pieces=slug.match(Downcoder.regex);if(pieces){for(var i=0;i<pieces.length;i++){if(pieces[i].length==1){var mapped=Downcoder.map[pieces[i]];if(mapped!=null){downcoded+=mapped;continue}}downcoded+=pieces[i]}}else{downcoded=slug}return downcoded};Flatdoc.slugify=function(s,num_chars){s=downcode(s);s=s.replace(/[^-\w\s]/g,"");s=s.replace(/^\s+|\s+$/g,"");s=s.replace(/[-\s]+/g,"-");s=s.toLowerCase();return s.substring(0,num_chars)};})();
